      ...
      backgroundColor: {
        ...
        component: {
          ...
          secondary: {
            ...
            hover:
              'rgba(var(--bg-component-secondary-hover))',
          },
        },
        action: {
        ...
        positive: {
          ...
          pressed:
            'rgba(var(--bg-positive-primary-pressed))',
          secondary: {
            DEFAULT: 'rgba(var(--bg-positive-secondary))',
            hover:
              'rgba(var(--bg-positive-secondary-hover))',
            pressed:
              'rgba(var(--bg-positive-secondary-pressed))',
          },
        },
        negative: {
          ...
          pressed:
            'rgba(var(--bg-negative-primary-pressed))',
          secondary: {
            DEFAULT: 'rgba(var(--bg-negative-secondary))',
            hover:
              'rgba(var(--bg-negative-secondary-hover))',
            pressed:
              'rgba(var(--bg-negative-secondary-pressed))',
          },
        },
        warning: {
          ...
          pressed:
            'rgba(var(--bg-warning-primary-pressed))',
          secondary: {
            DEFAULT: 'rgba(var(--bg-warning-secondary))',
            hover:
              'rgba(var(--bg-warning-secondary-hover))',
            pressed:
              'rgba(var(--bg-warning-secondary-pressed))',
          },
        },
      },
      colors: {
        ...
        action: {
          ...
          hover:
            'rgba(var(--content-action-primary-hover))',
          pressed:
            'rgba(var(--content-action-primary-pressed))',
          on: {
            primary:
              'rgba(var(--content-action-on-primary))',
            secondary:
              'rgba(var(--content-action-on-secondary))',
            tertiary:
              'rgba(var(--content-action-on-tertiary))',
          },
        },
        positive: {
          ...
          on: {
            primary:
              'rgba(var(--content-positive-on-primary))',
            secondary:
              'rgba(var(--content-positive-on-secondary))',
          },
        },
        negative: {
          ...
          on: {
            primary:
              'rgba(var(--content-negative-on-primary))',
            secondary:
              'rgba(var(--content-negative-on-secondary))',
          },
        },
        warning: {
          ...
          on: {
            primary:
              'rgba(var(--content-warning-on-primary))',
            secondary:
              'rgba(var(--content-warning-on-secondary))',
          },
        },
      },
      borderColor: {
        ...
        negative: {
          ...
          secondary:
            'rgba(var(--border-negative-secondary))',
        },
        positive: {
          DEFAULT: 'rgba(var(--border-positive-primary))',
          secondary:
            'rgba(var(--border-positive-secondary))',
        },
        warning: {
          DEFAULT: 'rgba(var(--border-warning-primary))',
          secondary:
            'rgba(var(--border-warning-secondary))',
        },
